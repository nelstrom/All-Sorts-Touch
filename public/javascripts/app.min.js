...
App.noun_detail.load();App.views.viewport.setActiveItem(App.views.nounscard);App.views.nounscard.setActiveItem(App.views.noun_detail_card)},updateButtons:function(a){var d=Ext.getCmp("prev_noun_letter_button"),e=Ext.getCmp("next_noun_letter_button"),b,c;a="abcdefghijklmnopqrstuvwxyz".indexOf(a);b=a-1;c=a+1;d.handler=function(){Ext.dispatch({controller:"nouns",action:"index",letter:"abcdefghijklmnopqrstuvwxyz"[b],historyUrl:"nouns/by/"+"abcdefghijklmnopqrstuvwxyz"[b]})};e.handler=function(){Ext.dispatch({controller:"nouns",
action:"index",letter:"abcdefghijklmnopqrstuvwxyz"[c],historyUrl:"nouns/by/"+"abcdefghijklmnopqrstuvwxyz"[c]})}}});
